...
import { requestAlumni } from "../../../Actions/AuthActions";
import styles from "./AlumniRegFormForm.module.css";

const AlumniRegFormForm = ({ requestAlumni }) => {
  ...
  const onSubmitHandeler = async (values) => {
    ...
    let check = await requestAlumni(values, img);
    if (check === true) {
      setLoading(false);
    } else {
      setLoading(false);
...
export default connect(null, { requestAlumni })(AlumniRegFormForm);
