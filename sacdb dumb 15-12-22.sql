...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2022 at 06:47 AM
...
(1603036, 16, 'Dibbo Borua', 'http://localhost:8080/resource/images?imageName=memberImage1603036.PNG', 'Bangladesh', 'Rajshahi', '', 'nazm.nahid@gmail.com', '01797975508', '7 am to 11 pm', '4ad9412ab52e9e25294b8140d7faa32bfd2c237b92781f9bc8859eb705e920f076500d6e16c50cc5', NULL),
...
CREATE TABLE `post` (
  ...
  `post_type` int(11) NOT NULL DEFAULT 0 COMMENT '1-> normal post\r\n2->job post'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
