...
//    }
    ...
    @GetMapping("/users")
    public HashMap<String,Object> searchUsers(@RequestParam(name ="pageNumber" ,required = false, defaultValue = "0") Integer pageNumber,@RequestParam(name ="searchText" ,required = false) String searchText){
        HashMap<String,Object> returnObj = new HashMap<>();
