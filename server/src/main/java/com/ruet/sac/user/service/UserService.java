...
public class UserService {
    ...
    public void registration(String name , Integer studentId , String email , String contactNo,
                             ...
                             String password , MultipartFile memberPhoto,MultipartFile documentImage)
    {
        ...
        {
            String imageName = fileUploadService.saveFile(documentImage ,"memberDocumentImage"+studentId);
            member.setDocument(deployUrl+imagePath+"?imageName="+imageName);
        }
